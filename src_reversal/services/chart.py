"""Chart generation service for reversal signals."""
...
from src_reversal.utils.indicators import calculate_rsi_series, calculate_macd
...
class ChartGenerator:
    ...
    INDICATOR_WARMUP = 40
    # Number of candles to display after warmup
    DISPLAY_CANDLES = 100
    ...
    def _create_hlines(self, levels: list, df: pd.DataFrame) -> dict | None:
        ...
        colors = ["#ff5252" for _ in resistance_prices] + [
